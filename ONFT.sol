...
// File: contracts\openzeppelin-contracts\contracts\utils\structs\EnumerableSet.sol
...
contract ONFT {
    ...
    function tokenURI(uint256 tokenId) external view returns(string memory){
        return string(abi.encodePacked(uri, Strings.toString(getType(tokenId))));
    }
